    ...
    'eco-shopify': [
      ...
      },
      {
        ...
        opciones: [
          ...
          { id: 'mercadopago',  label: 'Mercado Pago',                          add: 1500, icon: 'wallet', intent: 'engagement' },
          { id: 'mercadolibre', label: 'Mercado Libre (sincronización)',        add: 2500, icon: 'marketplace', intent: 'marketing' },
          { id: 'oxxo-spei',    label: 'OXXO Pay / SPEI (efectivo + transferencia)', add: 2000, icon: 'cash', intent: 'engagement' },
          { id: 'paypal',       label: 'PayPal',                                add: 1200, icon: 'wallet' },
          { id: 'apple-google', label: 'Apple Pay / Google Pay',                add: 1500, icon: 'phonepay' },
          { id: 'pos-retail',   label: 'POS / Retail físico (Shopify POS)',     add: 4000, icon: 'shield', intent: 'engagement' },
          { id: 'cripto',       label: 'Criptomonedas (USDC, BTC)',             add: 5000, icon: 'coin', intent: 'lanzamiento' },
    ...
    'eco-headless': [
      ...
      },
      {
        ...
        opciones: [
          ...
          { id: 'mercadopago',  label: 'Mercado Pago',                          add: 2000, icon: 'wallet', intent: 'engagement' },
          { id: 'mercadolibre', label: 'Mercado Libre (sincronización)',        add: 3000, icon: 'marketplace', intent: 'marketing' },
          { id: 'oxxo-spei',    label: 'OXXO Pay / SPEI (efectivo + transferencia)', add: 2500, icon: 'cash', intent: 'engagement' },
          { id: 'paypal',       label: 'PayPal',                                add: 1500, icon: 'wallet' },
          { id: 'apple-google', label: 'Apple Pay / Google Pay',                add: 2000, icon: 'phonepay' },
          { id: 'pos-retail',   label: 'POS / Retail físico',                   add: 5000, icon: 'shield', intent: 'engagement' },
          { id: 'cripto',       label: 'Criptomonedas (USDC, BTC)',             add: 6000, icon: 'coin', intent: 'lanzamiento' },
  ...
  universales: [
    ...
    },
    {
      ...
      opciones: [
        ...
        { id: 'estandar', label: 'Estándar · 1 a 3 meses',       mul: 1.0, icon: 'clock',
          description: 'Ritmo cómodo, sin recargo ni descuento.' },
        { id: 'flexible', label: 'Flexible · 3+ meses',          mul: 0.95, metaSuffix: '−5%', icon: 'star', intent: 'lanzamiento',
