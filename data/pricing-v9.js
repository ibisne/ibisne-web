  ...
  subflow: {
    ...
    'web-bio': {
      byType: {
        ...
        'bento': [
          ...
          { id: 'cta', icon: 'leads', label: '¿Cuál es la acción principal que esperas?', opciones: [
        ...
        'mini-portfolio': [
          { id: 'galeria', icon: 'star', label: '¿Cuántas piezas/trabajos vas a mostrar?', opciones: [
          ...
          { id: 'contacto', icon: 'envelope', label: '¿Cómo te contactan los clientes potenciales?', opciones: [
      ...
      shared: [
        { id: 'acabado', icon: 'palette', label: '¿Acabado del diseño?', opciones: [
          ...
          { id: 'balance',   icon: 'palette', label: 'Balance · calidad/precio óptimo',       subtitle: 'Lo más común · buena relación precio',    mul: 1.05 },
        ...
        { id: 'plazo', icon: 'clock', label: '¿Cuándo lo necesitas listo?', help: 'Express duplica el equipo · cuesta más pero entrega antes.', opciones: [
          { id: 'flexible', icon: 'clock', label: 'Flexible · cuando salga',  subtitle: 'Sin prisa · más barato',                                 mul: 0.95 },
          { id: 'normal',   icon: 'app',   label: 'Normal · plazo estándar',  subtitle: 'Ritmo cómodo · 1-2 semanas según tipo',                  mul: 1.05 },
    ...
    'web-landing': {
      byType: {
        'lead-gen': [
          ...
          { id: 'integraciones', icon: 'partnership', label: '¿Conexión a tus sistemas?', multi: true, opciones: [
        ...
        'producto': [
          ...
          { id: 'social-proof', icon: 'partnership', label: '¿Social proof?', multi: true, opciones: [
          ...
          { id: 'urgencia', icon: 'clock', label: '¿Mecanismos de urgencia?', multi: true, opciones: [
        ...
        'evento': [
          ...
          { id: 'recordatorios', icon: 'bell', label: '¿Recordatorios automáticos?', multi: true, opciones: [
        ...
        'venta-servicios': [
          ...
          { id: 'cta-principal', icon: 'leads', label: '¿CTA principal?', opciones: [
      ...
      shared: [
        { id: 'acabado', icon: 'palette', label: '¿Acabado del diseño?', opciones: [
          ...
          { id: 'balance',   label: 'Balance · calidad/precio óptimo',       mul: 1.05 },
          { id: 'premium',   label: 'Premium · animaciones + pulido máximo', mul: 1.35, flag: 'animacion-pro' },
        ]},
        { id: 'plazo', icon: 'clock', label: '¿Plazo deseado?', opciones: [
          { id: 'flexible', label: 'Flexible · cuando salga',  mul: 0.95 },
          { id: 'normal',   label: 'Normal · plazo estándar',  mul: 1.05 },
    ...
    'web-funnel': {
      byType: {
        'venta-directa': [
          ...
          { id: 'pasarela', icon: 'phonepay', label: '¿Pasarelas de pago?', opciones: [
        ...
        'captura-leads': [
          ...
          { id: 'nurture', icon: 'envelope', label: '¿Secuencia de nurture?', opciones: [
          ...
          { id: 'crm', icon: 'help-circle', label: '¿Integración con CRM?', opciones: [
        ...
        'upsell': [
          ...
          { id: 'upsells', icon: 'trending-up', label: '¿Cuántos upsells post-compra?', opciones: [
        ...
        'webinar': [
          ...
          { id: 'plataforma', icon: 'wrench', label: '¿Plataforma del webinar?', opciones: [
          ...
          { id: 'recordatorios', icon: 'bell', label: '¿Recordatorios pre-webinar?', multi: true, opciones: [
            { id: 'email-1week', label: 'Email 1 semana antes',  add: 1500 },
            { id: 'email-1day',  label: 'Email 1 día antes',     add: 1500 },
    ...
    'web-sitio': {
      byType: {
        'corporate-basico': [
          ...
          { id: 'contacto', icon: 'envelope', label: '¿Cómo te contactan?', opciones: [
        ...
        'corporate-completo': [
          { id: 'secciones', icon: 'grid', label: '¿Cuántas secciones principales?', opciones: [
          ...
          { id: 'cms', icon: 'wrench', label: '¿Qué CMS?', opciones: [
          ...
          { id: 'integraciones', icon: 'partnership', label: '¿Integraciones?', multi: true, opciones: [
        ...
        'portal-miembros': [
          { id: 'niveles', icon: 'shield', label: '¿Cuántos niveles de membresía?', opciones: [
          ...
          { id: 'auth', icon: 'login', label: '¿Cómo se autentican?', opciones: [
          ...
          { id: 'contenido', icon: 'help-circle', label: '¿Tipo de contenido privado?', multi: true, opciones: [
        ...
        'blog-magazine': [
          ...
          { id: 'monetiz', icon: 'wallet', label: '¿Monetización?', multi: true, opciones: [
        ...
        'catalogo-no-tx': [
          ...
          { id: 'cta', icon: 'leads', label: '¿CTA de contacto?', opciones: [
          ...
          { id: 'b2b', icon: 'shield', label: '¿Funciones B2B?', multi: true, opciones: [
        ...
        'docs-wiki': [
          ...
          { id: 'feedback', icon: 'chatbot', label: '¿Feedback en docs?', multi: true, opciones: [
            { id: 'util', icon: 'help-circle', label: '¿Te fue útil? thumbs up/down',      add: 2500 },
        ...
        'multi-idioma-serio': [
          { id: 'idiomas', icon: 'partnership', label: '¿Cuántos idiomas?', opciones: [
            { id: 'tres',  label: '3 idiomas',                            add: 22500 },
            { id: 'cinco', label: '4-5 idiomas',                          add: 47500 },
            { id: 'siete', label: '6+ idiomas',                           add: 85000 },
          ]},
          { id: 'cms-multi', icon: 'wrench', label: '¿CMS multilingüe?', opciones: [
          ...
          { id: 'localizacion', icon: 'partnership', label: '¿Localización avanzada?', multi: true, opciones: [
          ...
          { id: 'seo-multi', icon: 'help-circle', label: '¿SEO multi-idioma?', opciones: [
        ...
        'editorial-story': [
          ...
          { id: 'scroll-anim', icon: 'star', label: '¿Nivel de animaciones scroll?', opciones: [
          ...
          { id: 'media-rich', icon: 'help-circle', label: '¿Media embebida?', multi: true, opciones: [
          ...
          { id: 'share', icon: 'share', label: '¿Compartir?', multi: true, opciones: [
    ...
    'plat-chatbot': {
      byType: {
        'faq': [
          ...
          { id: 'fuentes', icon: 'help-circle', label: '¿De dónde sale la info?', multi: true, opciones: [
        ...
        'leads': [
          ...
          { id: 'destino', icon: 'leads', label: '¿A dónde llega el lead?', multi: true, opciones: [
        ...
        'postventa': [
          { id: 'casos', icon: 'star', label: '¿Qué tipo de casos atiende?', multi: true, opciones: [
          ...
          { id: 'integracion-tienda', icon: 'wrench', label: '¿Integración con tu tienda?', opciones: [
        ...
        'asistente-ia': [
          ...
          { id: 'tools', icon: 'wrench', label: '¿Tools/funciones disponibles?', multi: true, opciones: [
          ...
          { id: 'guardrails', icon: 'shield', label: '¿Reglas y guardrails?', opciones: [
    ...
    'plat-agenda': {
      byType: {
        ...
        'equipo': [
          { id: 'staff', icon: 'users', label: '¿Cuántos profesionales?', opciones: [
        ...
        'multi-sede': [
          { id: 'sedes', icon: 'map-pin', label: '¿Cuántas sedes?', opciones: [
        ...
        'con-pagos': [
          { id: 'pasarela', icon: 'phonepay', label: '¿Pasarela de pago?', opciones: [
      ...
      shared: [
        { id: 'recordatorios', icon: 'bell', label: '¿Recordatorios?', multi: true, opciones: [
        ...
        { id: 'sync', icon: 'partnership', label: '¿Sincronización con calendarios?', multi: true, opciones: [
    ...
    'plat-integraciones': {
      byType: {
        ...
        'hub-multi': [
          { id: 'cantidad', icon: 'grid', label: '¿Cuántos sistemas?', opciones: [
          ...
          { id: 'monitoring', icon: 'bar-chart', label: '¿Monitoreo?', opciones: [
        ...
        'etl-batch': [
          ...
          { id: 'destino', icon: 'leads', label: '¿Destino del ETL?', opciones: [
          ...
          { id: 'validacion', icon: 'shield-check', label: '¿Validación de calidad?', opciones: [
        ...
        'tiempo-real': [
          ...
          { id: 'fallback-rt', icon: 'shield', label: '¿Fallback si falla destino?', opciones: [
    ...
    'plat-procesos': {
      byType: {
        'aprobaciones': [
          ...
          { id: 'audit', icon: 'help-circle', label: '¿Audit log?', opciones: [
        ...
        'reportes': [
          ...
          { id: 'distribucion', icon: 'share', label: '¿Cómo se distribuye?', multi: true, opciones: [
        ...
        'extraccion': [
          { id: 'fuente', icon: 'help-circle', label: '¿De dónde extraes?', opciones: [
          ...
          { id: 'destino-ext', icon: 'leads', label: '¿Dónde van los datos?', opciones: [
            { id: 'sheets',  label: 'Google Sheets',                      add: 2500 },
      ...
      shared: [
        ...
        { id: 'plataforma-proc', icon: 'wrench', label: '¿Stack?', opciones: [
          { id: 'nocode', label: 'No-code · Zapier/Make/n8n', mul: 0.7 },
          { id: 'low',    label: 'Low-code · Retool/Internal', mul: 0.85 },
          { id: 'medida', label: 'A la medida · código propio', mul: 1.05 },
        ]},
        { id: 'plazo', icon: 'clock', label: '¿Plazo deseado?', opciones: [
          { id: 'flexible', label: 'Flexible · cuando salga',  mul: 0.95 },
          { id: 'normal',   label: 'Normal · plazo estándar',  mul: 1.05 },
    ...
    'plat-asesoria': {
      byType: {
        'estrategia': [
          { id: 'alcance', icon: 'star', label: '¿Alcance de la consultoría?', opciones: [
            { id: 'sesion',   label: '1 sesión · 1h',                     add: 500 },
          ...
          { id: 'foco', icon: 'star', label: '¿Foco principal?', multi: true, opciones: [
          ...
          { id: 'entregables', icon: 'help-circle', label: '¿Entregables?', multi: true, opciones: [
        ...
        'ia': [
          { id: 'nivel-equipo', icon: 'users', label: '¿Nivel técnico de tu equipo?', opciones: [
            { id: 'cero',     label: 'Cero · no han usado IA',            add: 500 },
            { id: 'basico',   label: 'Básico · ChatGPT diario',           add: 500 },
            { id: 'medio',    label: 'Medio · usan API/Cursor',           add: 1500 },
            { id: 'avanzado', label: 'Avanzado · ya hacen prompts custom', add: 3500 },
          ]},
          { id: 'foco-ia', icon: 'star', label: '¿Foco?', multi: true, opciones: [
          ...
          { id: 'modalidad-ia', icon: 'star', label: '¿Modalidad?', opciones: [
        ...
        'ecommerce': [
          { id: 'etapa', icon: 'history', label: '¿Etapa de tu tienda?', opciones: [
            { id: 'cero',   label: 'Cero · no he lanzado',                add: 500 },
            { id: 'lanzado', label: 'Lanzada · 0-$50k/mes',                add: 500 },
            { id: 'creci',   label: 'Creciendo · $50k-$500k/mes',          add: 2500 },
            { id: 'escala',  label: 'Escala · $500k+/mes',                 add: 5000 },
          ]},
          { id: 'foco-ec', icon: 'star', label: '¿Foco?', multi: true, opciones: [
          ...
          { id: 'modalidad-ec', icon: 'help-circle', label: '¿Modalidad?', opciones: [
        ...
        'formacion-equipo': [
          { id: 'tamano-equipo', icon: 'bar-chart', label: '¿Tamaño del equipo a capacitar?', opciones: [
            { id: 'chico',  label: 'Chico · 1-5 personas',                add: 500 },
            { id: 'medio',  label: 'Medio · 6-15 personas',               add: 2500 },
            { id: 'grande', label: 'Grande · 16+ personas',               add: 7500 },
          ]},
          { id: 'tema-form', icon: 'star', label: '¿Tema?', multi: true, opciones: [
            { id: 'js',       label: 'JavaScript / TypeScript',           add: 500 },
            { id: 'react',    label: 'React / Next.js',                   add: 500 },
            { id: 'node',     label: 'Node.js · backend',                 add: 500 },
            { id: 'db',       label: 'Bases de datos · SQL',              add: 500 },
            { id: 'cloud',    label: 'Cloud (AWS/GCP)',                   add: 1500 },
            { id: 'devops',   label: 'DevOps / CI-CD',                    add: 1500 },
            { id: 'ia',       label: 'IA y prompts',                      add: 1500 },
            { id: 'producto', label: 'Producto / discovery',              add: 500 },
          ]},
          { id: 'formato-form', icon: 'calendar', label: '¿Formato?', opciones: [
            { id: 'sesion',  label: 'Sesión única · 2h',                  add: 500 },
      ...
      shared: [
        { id: 'modalidad-presencia', icon: 'map-pin', label: '¿Presencial o remoto?', opciones: [
          { id: 'remoto',   label: 'Remoto · Zoom/Meet',                 add: 500 },
          { id: 'gdl',      label: 'Presencial · Guadalajara',           add: 1500 },
          { id: 'mx',       label: 'Presencial · CDMX/MTY/cualquier MX', add: 4500 },
        ]},
        { id: 'plazo', icon: 'clock', label: '¿Cuándo lo necesitas?', opciones: [
          { id: 'flexible', label: 'Flexible · próximas semanas',         mul: 0.95 },
          { id: 'normal',   label: 'Normal · 1-2 semanas',                mul: 1.05 },
    ...
    'plat-crm': {
      byType: {
        'ventas': [
          ...
          { id: 'actividades', icon: 'help-circle', label: '¿Tracking de actividades?', multi: true, opciones: [
    ...
    'plat-saas': {
      byType: {
        'vertical-niche': [
          { id: 'industria', icon: 'help-circle', label: '¿Qué industria?', opciones: [
          ...
          { id: 'compliance', icon: 'shield-check', label: '¿Compliance específico?', multi: true, opciones: [
        ...
        'horizontal-tool': [
          ...
          { id: 'integraciones-saas', icon: 'partnership', label: '¿Integraciones de día 1?', opciones: [
        ...
        'marketplace': [
          ...
          { id: 'matching-mp', icon: 'partnership', label: '¿Matching/búsqueda?', opciones: [
          ...
          { id: 'reputacion', icon: 'star', label: '¿Sistema de reputación?', multi: true, opciones: [
        ...
        'b2b-internal': [
          ...
          { id: 'auditoria-saas', icon: 'shield-check', label: '¿Audit log?', opciones: [
    ...
    'plat-erp': {
      byType: {
        'manufactura': [
          ...
          { id: 'bom', icon: 'help-circle', label: '¿BOM (lista de materiales)?', opciones: [
          ...
          { id: 'planta', icon: 'help-circle', label: '¿Control de planta?', multi: true, opciones: [
          ...
          { id: 'mrp', icon: 'bar-chart', label: '¿MRP (planificación)?', opciones: [
        ...
        'retail': [
          ...
          { id: 'pos', icon: 'ecommerce', label: '¿POS integrado?', opciones: [
          ...
          { id: 'proveedores', icon: 'partnership', label: '¿Gestión de proveedores?', multi: true, opciones: [
        ...
        'servicios': [
          ...
          { id: 'recursos', icon: 'users', label: '¿Gestión de recursos?', multi: true, opciones: [
          ...
          { id: 'facturacion-erp', icon: 'help-circle', label: '¿Facturación?', opciones: [
        ...
        'multi-vertical': [
          { id: 'unidades', icon: 'help-circle', label: '¿Cuántas unidades de negocio?', opciones: [
          ...
          { id: 'reportes-grupo', icon: 'bar-chart', label: '¿Reportes consolidados?', opciones: [
      ...
      shared: [
        { id: 'modulos-erp', icon: 'grid', label: '¿Módulos adicionales?', multi: true, help: 'Marca los que NO están en el tipo de ERP elegido pero quieres incluir.', opciones: [
    ...
    'plat-blockchain': {
      byType: {
        'token-utility': [
          ...
          { id: 'caracteristicas', icon: 'wrench', label: '¿Características?', multi: true, opciones: [
          ...
          { id: 'distribucion', icon: 'share', label: '¿Cómo se distribuye?', opciones: [
        ...
        'nft-collection': [
          ...
          { id: 'mecanica-mint', icon: 'star', label: '¿Mecánica de mint?', opciones: [
        ...
        'defi-basico': [
          { id: 'producto-defi', icon: 'wallet', label: '¿Qué producto DeFi?', opciones: [
        ...
        'smart-contract-biz': [
          { id: 'logica', icon: 'wrench', label: '¿Tipo de lógica?', opciones: [
...
(function expandSharedMarkers(){
  ...
  const APP_SUBFLOW_V9 = {
    ...
    preShared: [
      { id: 'vibe', icon: 'palette', label: '¿Qué vibe tiene tu proyecto?',
    ...
    byType: {
      ...
      'catalogo': [
        ...
        { id: 'cta-cat', icon: 'leads', label: '¿Cómo se contactan los clientes con tu negocio?', opciones: [
        ...
        { id: 'extras-cat', icon: 'plus', label: '¿Necesitas algo más?', multi: true,
      ...
      'contenido': [
        { id: 'tipo-contenido', icon: 'play', label: '¿Qué tipo de contenido distribuyes?', multi: true, opciones: [
        ...
        { id: 'social-contenido', icon: 'partnership', label: '¿Hay interacción social entre usuarios?', multi: true, opciones: [
      ...
      'transacciones': [
        { id: 'tipo-tx', icon: 'fintech', label: '¿Qué tipo de transacción manejas?', opciones: [
        ...
        { id: 'pasarela-tx', icon: 'phonepay', label: '¿Qué métodos de pago aceptas?', multi: true,
        ...
        { id: 'historial-tx', icon: 'history', label: '¿Necesitas que el usuario tenga historial de movimientos?', opciones: [
      ...
      'productividad': [
        { id: 'modulos-prod', icon: 'grid', label: '¿Qué funciones necesita tu herramienta?', multi: true,
      ...
      'social-comunidad': [
        ...
        { id: 'monetizacion-social', icon: 'wallet', label: '¿Cómo monetizas la comunidad?', multi: true, opciones: [
      ...
      'servicios-citas': [
        ...
        { id: 'historial-cita', icon: 'history', label: '¿Necesitas guardar info de tus clientes?', opciones: [
        ...
        { id: 'recordatorios-cita', icon: 'bell', label: '¿Cómo avisas a tus clientes antes de la cita?', multi: true,
      ...
      'generico': [
        { id: 'que-hace', icon: 'help-circle', label: '¿Qué hace tu app a grandes rasgos?', opciones: [
    ...
    shared: [
      ...
      { id: 'plazo', icon: 'clock', label: '¿Cuándo necesitas la app lista?',
        ...
        { id: 'normal',   icon: 'app',    label: 'Plazo normal',
          subtitle: '6 a 16 semanas según servicio · ritmo de trabajo cómodo',                                       mul: 1.05 },
  ...
  const EC_SUBFLOW_V9 = {
    byType: {
      'fisico': [
        ...
        { id: 'inventario-fisico', icon: 'ecommerce', label: '¿Manejo de inventario?', opciones: [
      ...
      'digital': [
        ...
        { id: 'entrega-digital', icon: 'envelope', label: '¿Entrega?', opciones: [
      ...
      'servicio': [
        { id: 'tipo-servicio-ec', icon: 'help-circle', label: '¿Tipo de servicio?', opciones: [
        ...
        { id: 'agenda-ec', icon: 'calendar', label: '¿Cómo se agenda?', opciones: [
        ...
        { id: 'recordatorios-ec', icon: 'bell', label: '¿Recordatorios?', multi: true, opciones: [
      ...
      'mixto': [
        { id: 'cantidad-categorias', icon: 'grid', label: '¿Cuántas categorías de producto?', opciones: [
        ...
        { id: 'envios-mixto', icon: 'ecommerce', label: '¿Envíos / entrega?', opciones: [
    ...
    shared: [
      { id: 'pagos-ec', icon: 'wallet', label: '¿Pasarelas de pago?', multi: true, opciones: [
  ...
  const WEB_PRESHARED = [
    { id: 'vibe', icon: 'palette', label: '¿Qué vibe tiene tu proyecto web?',
      help: 'Esto nos ayuda a recomendar opciones acordes · podrás cambiar de idea en cualquier momento.', opciones: [
      { id: 'mvp',      icon: 'leads',       label: 'MVP / Económico',
        subtitle: 'Salir rápido al mercado · lo esencial · iteras después con datos',                              mul: 0.80 },
      { id: 'balance',  icon: 'palette',     label: 'Balance',
  ...
  const EC_PRESHARED = [
    { id: 'vibe', icon: 'palette', label: '¿Qué vibe tiene tu tienda online?',
      help: 'Esto nos ayuda a recomendar opciones acordes · podrás cambiar de idea en cualquier momento.', opciones: [
      { id: 'mvp',      icon: 'leads',       label: 'MVP / Económico',
  ...
  const PLAT_PRESHARED = [
    { id: 'vibe', icon: 'palette', label: '¿Qué vibe tiene tu plataforma interna?',
